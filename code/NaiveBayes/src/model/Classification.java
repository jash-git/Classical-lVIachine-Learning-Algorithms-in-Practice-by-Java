...
public class Classification {
	...
	public Classification(HashMap<String, Double> hamMap, HashMap<String, Double> spamMap, double hamProbability,
			double spamProbability, double hamWordsCount, double spamWordsCount, double count) {
		this.hamMap = hamMap;
